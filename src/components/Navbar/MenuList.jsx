			...
			<StyledList>
				<ListItem disablePadding>
					<ListItemButton onClick={() => navigate("/profile")}>
						<ListItemIcon>
							<ManageAccountsIcon sx={{ fontSize: 40 }} color="blue" />
						</ListItemIcon>
			...
			<StyledList>
				<ListItem disablePadding>
					<ListItemButton onClick={() => navigate("/dashboard")}>
						<ListItemIcon>
							<BarChartIcon sx={{ fontSize: 40 }} color="blue" />
						</ListItemIcon>
			...
			<StyledList>
				<ListItem disablePadding>
					<ListItemButton onClick={() => navigate("/documents")}>
						<ListItemIcon>
							<PointOfSaleIcon sx={{ fontSize: 40 }} color="blue" />
						</ListItemIcon>
				...
				<StyledList>
					<ListItem disablePadding>
						<ListItemButton onClick={() => navigate("/users")}>
							<ListItemIcon>
								<AdminPanelSettingsIcon sx={{ fontSize: 40 }} color="yellow" />
							</ListItemIcon>
