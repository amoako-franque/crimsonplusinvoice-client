				...
				<Box
					...
					<Box>
						{data.user?.avatar ? (
							...
							<AccountCircleIcon sx={{ fontSize: "6rem" }} color="darkRed" />
						)}
					</Box>
					<StyledDivider />
					<Grid container>
								...
								<Stack>
									<List>
										...
										<ListItem>
											...
											<ListItemText
												primary={`First Name: ${data.user.firstname}`}
											/>
										</ListItem>
										{/* last name */}
										<ListItem>
											...
											<ListItemText
												primary={`Last Name: ${data.user.lastname}`}
											/>
										</ListItem>
										{/* username */}
										<ListItem>
											...
											<ListItemText
												primary={`Username: ${data.user.username}`}
											/>
										</ListItem>
										{/* address */}
										<ListItem>
